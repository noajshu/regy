...
var level4 = {levelTargets:[avgShark("00"), avgShark("10"), avgCat("001011"), avgShark("11"), avgShark("01"), avgShark("11")], levelInfo:"Try using the \\d character, which represents a single digit."};
