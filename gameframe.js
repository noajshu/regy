...
var level4 = {levelTargets:[avgShark("123"), avgShark("124"), avgCat("12a"), avgShark("125"), avgShark("126"), avgShark("127")], levelInfo:"Try using the \\d character, which represents a single digit."};
